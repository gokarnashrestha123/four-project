    ...
    <div className="relative min-h-screen py-15 md:py-20">
      ...
      <SectionContainer>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-7 lg:gap-8 relative z-10">
          ...
          // Hide all cards except first two on mobile
        ...
        `}
            ...
            >
              ...
              <img
                src={item.image}
                alt={item.title}
                className="absolute bottom-0 left-0 w-full h-96 object-bottom z-10 grayscale"
              />

              {/* Big Overlay Text (breaks lines and wraps) */}
